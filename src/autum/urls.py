...
from aws.views import aws, aws_cp, aws_home, aws_delete, aws_create, aws_monitor, aws_view, aws_monitor_list, aws_view_list, aws_view_delete
...
urlpatterns = [
    ...
    url(r'^aws_view_delete/$', aws_view_delete, name='aws_view_delete'),
