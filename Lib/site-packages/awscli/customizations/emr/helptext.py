...
INSTANCE_COUNT = (
    ...
    ' node as the cluster\'s main node and use the remainder of the nodes as'
...
EC2_ATTRIBUTES = (
    ...
    ' EmrManagedMainSecurityGroup, EmrManagedSubordinateSecurityGroup,'
    ' AdditionalMainSecurityGroups and AdditionalSubordinateSecurityGroups.'
    ...
    '<li>EmrManagedMainSecurityGroup - The identifier of the Amazon EC2'
    ' security group'
    ' for the main node. </li>'
    '<li>EmrManagedSubordinateSecurityGroup - The identifier of the Amazon EC2'
    ' security group'
    ' for the subordinate nodes.</li>'
    ...
    '<li>AdditionalMainSecurityGroups - A list of additional Amazon EC2'
    ' security group IDs for the main node</li>'
    '<li>AdditionalSubordinateSecurityGroups - A list of additional Amazon EC2'
